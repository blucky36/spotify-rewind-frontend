...
export default class AvailablePlaylists extends Component {
  ...
  noPlaylists = () => {
    if (this.props.state.awaitingAvailable) {
      return (<div style={{width:'100%', marginTop:10}} ><div className='fidget'></div></div>)
    } else {
      return (<div style={{width:'100%', marginTop:10, fontStyle:'italic'}}><h4>You have no playlists to back up!</h4></div>)
    }
  }
